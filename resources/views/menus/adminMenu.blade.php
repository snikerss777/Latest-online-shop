<div class="col-sm-3">
			<div class="panel panel-default">
				...
				<ul class=" nav nav-pills nav-stacked" >
	                ...
	                <li @if(Request::is('advertisement/create'))  class="active" @endif><a href="/advertisement/create"><i class="fa fa-list-alt fa-fw"></i>Dodaj produkt</a></li>
	                <li @if(Request::is('adminIndex'))  class="active" @endif><a href="/adminIndex"><i class="fa fa-list-alt fa-fw"></i>Lista produktów</a></li>
