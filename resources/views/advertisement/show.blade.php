								...
								@else 
									...
									<div class="row">
										<div class="col-sm-12 buttonCol">
											<a style="width:50%; text-align:center;" href="{{ URL::route('advertisement/edit/', ['id' => $advertisement->id]) }}" class="btn btn-primary btn-lg  right buttonDown2 ">Edytuj dane produktu</a>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12 buttonCol">
									...
									<div class="row">
										<div class="col-sm-12 buttonCol">
											<a style="width:50%; text-align:center;" href="{{ URL::route('advertisement/destroy/', ['id' => $advertisement->id]) }}" class="btn btn-warning btn-lg  right buttonDown2 ">Usuń produkt</a>
										</div>
									</div>
