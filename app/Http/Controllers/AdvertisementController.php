...
class AdvertisementController extends Controller {
	...
	public function adminIndex(){
		$advertisements = Advertisement::leftJoin('photos', 'advertisements.photo_id', '=', 'photos.id')
				->where('advertisement_status_id', 1)
				->select('advertisements.id as id', 'name', 'category_id' , 'icon_src as src', 'photo_id', 'price', 'number_of_copies' )
				->paginate(10);

		return view('advertisement.adminIndex', compact('advertisements'));
	}
